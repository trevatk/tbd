...
func (s *service) createRealm(ctx context.Context, create realmCreate) (realm, error) {
...
func (s *service) createUser(ctx context.Context, create userCreate) (user, error) {
